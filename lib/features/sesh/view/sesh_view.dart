...
class _SeshViewState extends State<SeshView> {
  ...
  Widget build(BuildContext context) {
    // Removed Scaffold, returning the SafeArea content directly
    return SafeArea(
      child: Padding(
            ...
            Row(
              ...
              children: [
                const Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Sesh AI", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                    Text("Your personal study assistant", style: TextStyle(color: Colors.white54)),
                  ],
                ),
                Container(
