...
exports.buildSchoolOnlyMessage = buildSchoolOnlyMessage;
exports.evaluateAcademicGuard = evaluateAcademicGuard;
...
function buildSchoolOnlyMessage(borderline = false) {
    if (borderline) {
...
function evaluateAcademicGuard(text) {
